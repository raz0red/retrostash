...
private:
    ...
    static u32 ReadSectorsInternal(RFILE* file, u64 filelen, u32 start, u32 num, u8* data);
    static u32 WriteSectorsInternal(RFILE* file, u64 filelen, u32 start, u32 num, u8* data);
