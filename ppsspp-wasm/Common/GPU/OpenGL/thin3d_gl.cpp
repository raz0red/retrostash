...
#if !defined(USING_GLES2) && !defined(USING_GLES3)   // TODO: Remove when we have better headers
	GL_SRC1_COLOR,
	GL_ONE_MINUS_SRC1_COLOR,
	GL_SRC1_ALPHA,
	GL_ONE_MINUS_SRC1_ALPHA,
#elif !defined(USING_GLES3) && !PPSSPP_PLATFORM(IOS)
	GL_SRC1_COLOR_EXT,
	GL_ONE_MINUS_SRC1_COLOR_EXT,
	GL_SRC1_ALPHA_EXT,
	GL_ONE_MINUS_SRC1_ALPHA_EXT,
#else
	// WRC - dual-source blending isn't part of GLES3/WebGL2 core (ES 3.0)
	// either, so USING_GLES3 lands here too, same as iOS.
	GL_INVALID_ENUM,
	GL_INVALID_ENUM,
	GL_INVALID_ENUM,
	GL_INVALID_ENUM,
...
static const unsigned short texWrapToGL[] = {
	...
	GL_MIRRORED_REPEAT,
	GL_CLAMP_TO_EDGE,
#if !defined(USING_GLES2) && !defined(USING_GLES3)
	GL_CLAMP_TO_BORDER,
#else
	// WRC - GL_CLAMP_TO_BORDER isn't core GLES3/WebGL2 (ES 3.0) either.
	GL_CLAMP_TO_EDGE,
#endif
};
