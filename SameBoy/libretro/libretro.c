...
#ifdef WRC
/* --- Gray palettes --- */
const GB_palette_t GB_PALETTE_GRAY0 = {{
    {0x00,0x00,0x00},
    {0x62,0x62,0x62},
    {0xAC,0xAC,0xAC},
    {0xFF,0xFF,0xFF},
...
/* --- Green palettes --- */
// const GB_palette_t GB_PALETTE_GREEN0 = {{
//     {0x20,0x52,0x00},
//     {0x18,0x6A,0x00},
//     {0x00,0xB4,0x00},
//     {0x31,0xE6,0x73},
...
const GB_palette_t GB_PALETTE_GREEN0 = {{
    ...
    {0x00,0xB0,0x00},  // c2
    {0x70,0xE0,0x30},  // c1
    {0x70,0xE0,0x30}   // duplicate of last
}};

const GB_palette_t GB_PALETTE_GREEN1 = {{
    {0x19,0x34,0x41},
    {0x53,0x92,0x74},
    {0xAE,0xD7,0x98},
    {0xEF,0xFF,0xE0},
...
const GB_palette_t GB_PALETTE_GREEN2 = {{
    {0x08,0x18,0x00},
    {0x48,0x88,0x18},
    {0x78,0xC8,0x38},
    {0xE0,0xF8,0xA0},
...
const GB_palette_t GB_PALETTE_GREEN3 = {{
    {0x0F,0x38,0x0F},
    {0x30,0x62,0x30},
    {0x8B,0xAC,0x0F},
    {0x9B,0xBC,0x0F},
...
const GB_palette_t GB_PALETTE_GREEN4 = {{
    {0x00,0x4F,0x3B},
    {0x00,0x69,0x4A},
    {0x00,0x9A,0x71},
    {0x00,0xB5,0x81},
...
const GB_palette_t GB_PALETTE_GREEN5 = {{
    {0x40,0x50,0x28},
    {0x80,0x88,0x40},
    {0xB8,0xC0,0x58},
    {0xF8,0xF8,0xC8},
...
const GB_palette_t GB_PALETTE_SGB1A = {{
    {0x30,0x18,0x50},
    {0xA8,0x28,0x20},
    {0xD8,0x90,0x48},
    {0xF8,0xE8,0xC8},
...
const GB_palette_t GB_PALETTE_SGB1B = {{
    {0x00,0x00,0x00},
    {0xB0,0x50,0x10},
    {0xC8,0xB0,0x70},
    {0xD8,0xD8,0xC0},
...
const GB_palette_t GB_PALETTE_SGB1C = {{
    {0x38,0x38,0x98},
    {0x98,0x38,0x60},
    {0xE8,0x98,0x50},
    {0xF8,0xC0,0xF8},
...
const GB_palette_t GB_PALETTE_SGB1D = {{
    {0x50,0x18,0x00},
    {0xF8,0x00,0x00},
    {0xC0,0x80,0x48},
    {0xF8,0xF8,0xA8},
...
const GB_palette_t GB_PALETTE_SGB1E = {{
    {0x58,0x38,0x20},
    {0x68,0x88,0x40},
    {0x78,0xC0,0x78},
    {0xF8,0xD8,0xB0},
...
const GB_palette_t GB_PALETTE_SGB1F = {{
    {0x00,0x40,0x10},
    {0xA8,0x00,0x00},
    {0xE0,0x88,0x50},
    {0xD8,0xE8,0xF8},
...
const GB_palette_t GB_PALETTE_SGB1G = {{
    {0xF8,0xF8,0x58},
    {0x78,0x78,0x00},
    {0x00,0xA0,0xE8},
    {0x00,0x00,0x50},
...
const GB_palette_t GB_PALETTE_SGB1H = {{
    {0x30,0x18,0x00},
    {0x80,0x40,0x00},
    {0xF8,0xB8,0x88},
    {0xF8,0xE8,0xE0},
...
/* --- SGB2 palettes --- */
const GB_palette_t GB_PALETTE_SGB2A = {{
    {0x00,0x00,0x00},
    {0x28,0x78,0x00},
    {0xC0,0x88,0x48},
    {0xF0,0xC8,0xA0},
...
const GB_palette_t GB_PALETTE_SGB2B = {{
    {0x50,0x00,0x58},
    {0xF8,0x30,0x00},
    {0xF8,0xE8,0x50},
    {0xF8,0xF8,0xF8},
...
const GB_palette_t GB_PALETTE_SGB2C = {{
    {0x28,0x28,0x98},
    {0x78,0x30,0xE8},
    {0xE8,0x88,0x88},
    {0xF8,0xC0,0xF8},
...
const GB_palette_t GB_PALETTE_SGB2D = {{
    {0x00,0x00,0x50},
    {0xF8,0x30,0x00},
    {0x00,0xF8,0x00},
    {0xF8,0xF8,0xA0},
...
const GB_palette_t GB_PALETTE_SGB2E = {{
    {0x10,0x08,0x10},
    {0x28,0x10,0x60},
    {0x90,0xB0,0xE0},
    {0xF8,0xC8,0x80},
...
const GB_palette_t GB_PALETTE_SGB2F = {{
    {0x18,0x00,0x00},
    {0xA0,0x00,0x00},
    {0xF8,0x90,0x50},
    {0xD0,0xF8,0xF8},
...
const GB_palette_t GB_PALETTE_SGB2G = {{
    {0x00,0x18,0x00},
    {0xE0,0xB8,0x80},
    {0xE0,0x50,0x40},
    {0x68,0xB8,0x38},
...
const GB_palette_t GB_PALETTE_SGB2H = {{
    {0x00,0x00,0x00},
    {0x70,0x70,0x70},
    {0xB8,0xB8,0xB8},
    {0xF8,0xF8,0xF8},
...
/* --- SGB3 palettes --- */
const GB_palette_t GB_PALETTE_SGB3A = {{
    {0x30,0x48,0x60},
    {0xF8,0x60,0x28},
    {0x70,0xC0,0xC0},
    {0xF8,0xD0,0x98},
...
const GB_palette_t GB_PALETTE_SGB3B = {{
    {0x00,0x10,0x10},
    {0x00,0x50,0x00},
    {0xE0,0x80,0x20},
    {0xD8,0xD8,0xC0},
...
const GB_palette_t GB_PALETTE_SGB3C = {{
    {0x20,0x20,0x58},
    {0x00,0xB8,0xF8},
    {0xF8,0xF8,0x78},
    {0xE0,0xA0,0xC8},
...
const GB_palette_t GB_PALETTE_SGB3D = {{
    {0x00,0x00,0x00},
    {0x08,0xC8,0x00},
    {0xE0,0xA8,0x78},
    {0xF0,0xF8,0xB8},
...
const GB_palette_t GB_PALETTE_SGB3E = {{
    {0x50,0x48,0x70},
    {0xB0,0x78,0x20},
    {0xE0,0xB0,0x68},
    {0xF8,0xF8,0xC0},
...
const GB_palette_t GB_PALETTE_SGB3F = {{
    {0x40,0x40,0x40},
    {0xF8,0xD0,0x00},
    {0xF8,0x68,0xF8},
    {0x78,0x78,0xC8},
...
const GB_palette_t GB_PALETTE_SGB3G = {{
    {0x38,0x00,0x00},
    {0xC8,0x30,0x38},
    {0xF8,0xF8,0xF8},
    {0x60,0xD8,0x50},
...
const GB_palette_t GB_PALETTE_SGB3H = {{
    {0x08,0x18,0x00},
    {0x48,0x88,0x18},
    {0x78,0xC8,0x38},
    {0xE0,0xF8,0xA0},
...
/* --- SGB4 palettes --- */
const GB_palette_t GB_PALETTE_SGB4A = {{
    {0x00,0x00,0x78},
    {0xD0,0x00,0xD0},
    {0x78,0xA8,0xF8},
    {0xF0,0xA8,0x68},
...
const GB_palette_t GB_PALETTE_SGB4B = {{
    {0x18,0x08,0x08},
    {0x40,0x78,0x38},
    {0xE8,0xA0,0x60},
    {0xF0,0xE8,0xF0},
...
const GB_palette_t GB_PALETTE_SGB4C = {{
    {0x08,0x00,0x00},
    {0x98,0xA0,0xE0},
    {0xD8,0xA0,0xD0},
    {0xF8,0xE0,0xE0},
...
const GB_palette_t GB_PALETTE_SGB4D = {{
    {0x08,0x20,0x48},
    {0x48,0x68,0x78},
    {0x90,0xC8,0xC8},
    {0xF8,0xF8,0xB8},
...
const GB_palette_t GB_PALETTE_SGB4E = {{
    {0x00,0x20,0x30},
    {0x78,0x58,0x88},
    {0xE0,0xA8,0x78},
    {0xF8,0xD8,0xA8},
...
const GB_palette_t GB_PALETTE_SGB4F = {{
    {0x38,0x00,0x00},
    {0x80,0x00,0xA0},
    {0xD8,0x80,0xD8},
    {0xB8,0xD0,0xD0},
...
const GB_palette_t GB_PALETTE_SGB4G = {{
    {0x00,0x80,0x60},
    {0x28,0x10,0x00},
    {0xB8,0x20,0x58},
    {0xB0,0xE0,0x18},
...
const GB_palette_t GB_PALETTE_SGB4H = {{
    {0x40,0x50,0x28},
    {0x80,0x88,0x40},
    {0xB8,0xC0,0x58},
    {0xF8,0xF8,0xC8},
...
static void GB_update_keys_status(GB_gameboy_t *gb, unsigned port)
{
    ...
    #ifdef WRC
    /* --- WebRcade custom input mapping --- */
    uint16_t keys = 0;

    /* Buttons */
    if (wrc_input_state[0] & INP_B)      keys |= 1 << 0;  // GB A
    if (wrc_input_state[0] & INP_X)      keys |= 1 << 0;
    if (wrc_input_state[0] & INP_A)      keys |= 1 << 1;  // GB B
    if (wrc_input_state[0] & INP_Y)      keys |= 1 << 1;
    if (wrc_input_state[0] & INP_SELECT) keys |= 1 << 2;  // Select
    if (wrc_input_state[0] & INP_START)  keys |= 1 << 3;  // Start

    /* D-Pad */
    if (wrc_input_state[0] & INP_RIGHT)  keys |= 1 << 4;  // Right
    if (wrc_input_state[0] & INP_LEFT)   keys |= 1 << 5;  // Left
    if (wrc_input_state[0] & INP_UP)     keys |= 1 << 6;  // Up
    if (wrc_input_state[0] & INP_DOWN)   keys |= 1 << 7;  // Down

    /* Map to SameBoy keys */
    GB_set_key_state_for_player(gb, GB_KEY_RIGHT,  0, keys & (1 << 4));
    GB_set_key_state_for_player(gb, GB_KEY_LEFT,   0, keys & (1 << 5));
    GB_set_key_state_for_player(gb, GB_KEY_UP,     0, keys & (1 << 6));
    GB_set_key_state_for_player(gb, GB_KEY_DOWN,   0, keys & (1 << 7));
    GB_set_key_state_for_player(gb, GB_KEY_A,      0, keys & (1 << 0));
    GB_set_key_state_for_player(gb, GB_KEY_B,      0, keys & (1 << 1));
    GB_set_key_state_for_player(gb, GB_KEY_SELECT, 0, keys & (1 << 2));
    GB_set_key_state_for_player(gb, GB_KEY_START,  0, keys & (1 << 3));
...
#ifdef WRC
        EM_ASM({ window.emulator.audioCallback($0, $1); }, buf_pos, remaining_frames);
        size_t uploaded_frames = remaining_frames;
#else
...
#else
#ifdef WRC
    // head hit tail:WIIU_SAMPLE_RATE * (60.0/59.95)
    // head hit tail:WIIU_SAMPLE_RATE
    // head hit tail:WIIU_SAMPLE_RATE * (59.95/60.0) 3+ minutes
    // head hit tail:WIIU_SAMPLE_RATE * (59.90/60.0) 3+ minutes
    // head hit tail:WIIU_SAMPLE_RATE * (59.85/60.0) 6+ minutes

    // GameBoy good
    //GB_set_sample_rate(&gameboy[i], WIIU_SAMPLE_RATE * (59.75/60.0));

    // GameBoy Color
    // head hit taiL: GB_set_sample_rate(&gameboy[i], WIIU_SAMPLE_RATE); ~ 2mins
...
#ifdef WRC
// VBA-M Value	Meaning	SameBoy Option String	SameBoy Model
// 0	Automatic	"Auto" or "Auto (SGB)"	GB_MODEL_AUTO
// 1	Game Boy Color	"Game Boy Color"	GB_MODEL_CGB_E
// 2	Super Game Boy	"Super Game Boy"	GB_MODEL_SGB_NTSC
// 3	Game Boy	"Game Boy"	GB_MODEL_DMG_B
// 4	Game Boy Advance	"Game Boy Advance"	GB_MODEL_AGB_A
// 5	Super Game Boy 2	"Super Game Boy 2"	GB_MODEL_SGB2

        int modelPropValue = EM_ASM_INT({
            return window.emulator.getModel();
        });
        switch (modelPropValue) {
            case 1: // Game Boy Color
                model[0] = GB_MODEL_CGB_E;
                break;
            case 2: // Super Game Boy
                model[0] = GB_MODEL_SGB_NTSC;
                break;
            case 3: // Game Boy
                model[0] = GB_MODEL_DMG_B;
                break;
            case 4: // Game Boy Advance
                model[0] = GB_MODEL_AGB_A;
                break;
            case 5: // Super Game Boy 2
                model[0] = GB_MODEL_SGB2;
                break;
            default:
                model[0] = GB_MODEL_AUTO;
                auto_sgb_enabled[0] = true;
...
#ifdef WRC
    int paletteIndex = EM_ASM_INT({
        return window.emulator.getPaletteIndex();
    });

    int colorIndex = EM_ASM_INT({
        return window.emulator.getColorIndex();
    });

printf("### Palette: %d, Color: %d\n", paletteIndex, colorIndex);

    // Greyscale palettes (paletteIndex = 0)
    if (paletteIndex == 0) {
        switch(colorIndex) {
            case 0: GB_set_palette(&gameboy[0], &GB_PALETTE_GRAY0); break;
        }
    }
    // Greenscale palettes (paletteIndex = 1)
    else if (paletteIndex == 1) {
        switch(colorIndex) {
            case 0: GB_set_palette(&gameboy[0], &GB_PALETTE_GREEN0); break;
            case 1: GB_set_palette(&gameboy[0], &GB_PALETTE_GREEN1); break;
            case 2: GB_set_palette(&gameboy[0], &GB_PALETTE_GREEN2); break;
            case 3: GB_set_palette(&gameboy[0], &GB_PALETTE_GREEN3); break;
            case 4: GB_set_palette(&gameboy[0], &GB_PALETTE_GREEN4); break;
            case 5: GB_set_palette(&gameboy[0], &GB_PALETTE_GREEN5); break;
        }
    }
    // Super Game Boy palettes (paletteIndex = 2)
    else if (paletteIndex == 2) {
        switch(colorIndex) {
            case 0: GB_set_palette(&gameboy[0], &GB_PALETTE_SGB1A); break;
            case 1: GB_set_palette(&gameboy[0], &GB_PALETTE_SGB1B); break;
            case 2: GB_set_palette(&gameboy[0], &GB_PALETTE_SGB1C); break;
            case 3: GB_set_palette(&gameboy[0], &GB_PALETTE_SGB1D); break;
            case 4: GB_set_palette(&gameboy[0], &GB_PALETTE_SGB1E); break;
            case 5: GB_set_palette(&gameboy[0], &GB_PALETTE_SGB1F); break;
            case 6: GB_set_palette(&gameboy[0], &GB_PALETTE_SGB1G); break;
            case 7: GB_set_palette(&gameboy[0], &GB_PALETTE_SGB1H); break;

            case 8: GB_set_palette(&gameboy[0], &GB_PALETTE_SGB2A); break;
            case 9: GB_set_palette(&gameboy[0], &GB_PALETTE_SGB2B); break;
            case 10: GB_set_palette(&gameboy[0], &GB_PALETTE_SGB2C); break;
            case 11: GB_set_palette(&gameboy[0], &GB_PALETTE_SGB2D); break;
            case 12: GB_set_palette(&gameboy[0], &GB_PALETTE_SGB2E); break;
            case 13: GB_set_palette(&gameboy[0], &GB_PALETTE_SGB2F); break;
            case 14: GB_set_palette(&gameboy[0], &GB_PALETTE_SGB2G); break;
            case 15: GB_set_palette(&gameboy[0], &GB_PALETTE_SGB2H); break;

            case 16: GB_set_palette(&gameboy[0], &GB_PALETTE_SGB3A); break;
            case 17: GB_set_palette(&gameboy[0], &GB_PALETTE_SGB3B); break;
            case 18: GB_set_palette(&gameboy[0], &GB_PALETTE_SGB3C); break;
            case 19: GB_set_palette(&gameboy[0], &GB_PALETTE_SGB3D); break;
            case 20: GB_set_palette(&gameboy[0], &GB_PALETTE_SGB3E); break;
            case 21: GB_set_palette(&gameboy[0], &GB_PALETTE_SGB3F); break;
            case 22: GB_set_palette(&gameboy[0], &GB_PALETTE_SGB3G); break;
            case 23: GB_set_palette(&gameboy[0], &GB_PALETTE_SGB3H); break;

            case 24: GB_set_palette(&gameboy[0], &GB_PALETTE_SGB4A); break;
            case 25: GB_set_palette(&gameboy[0], &GB_PALETTE_SGB4B); break;
            case 26: GB_set_palette(&gameboy[0], &GB_PALETTE_SGB4C); break;
            case 27: GB_set_palette(&gameboy[0], &GB_PALETTE_SGB4D); break;
            case 28: GB_set_palette(&gameboy[0], &GB_PALETTE_SGB4E); break;
            case 29: GB_set_palette(&gameboy[0], &GB_PALETTE_SGB4F); break;
            case 30: GB_set_palette(&gameboy[0], &GB_PALETTE_SGB4G); break;
            case 31: GB_set_palette(&gameboy[0], &GB_PALETTE_SGB4H); break;
        }
    }
    // Default palette
    else if (paletteIndex == 3) {
        switch(colorIndex) {
            case 0: GB_set_palette(&gameboy[0], &GB_PALETTE_GREY); break;
            case 1: GB_set_palette(&gameboy[0], &GB_PALETTE_DMG); break;
            case 2: GB_set_palette(&gameboy[0], &GB_PALETTE_MGB); break;
            case 3: GB_set_palette(&gameboy[0], &GB_PALETTE_GBL); break;
        }
    }
#endif
...
#ifdef WRC
        int borderOn = EM_ASM_INT({
            return window.emulator.getBorder();
        });
        if (borderOn) {
            GB_set_border_mode(&gameboy[0], borderOn == 1 ? GB_BORDER_ALWAYS : GB_BORDER_SGB);
        } else {
            GB_set_border_mode(&gameboy[0], GB_BORDER_NEVER);
        }
#endif
