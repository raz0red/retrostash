...
bool OpenGLRenderer::renderFrame(int width, int height)
{
	...
	// WebGL2 has no GL_PRIMITIVE_RESTART_FIXED_INDEX capability to toggle:
	// primitive restart is always implicitly enabled for indexed draws, and
	// calling glEnable() with this enum is GL_INVALID_ENUM under WebGL2.
