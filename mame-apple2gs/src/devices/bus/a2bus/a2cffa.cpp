...
static void wrc_disk_notify_quick() {
	// Quick pulse - LED stays on for duration set by JS layer
	wrc_disk_activity_set(1);
	wrc_disk_activity_set(0);
}
#endif
